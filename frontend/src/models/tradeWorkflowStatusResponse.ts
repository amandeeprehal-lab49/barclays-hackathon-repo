...
export interface TradeWorkflowStatusResponse { 
    tradeMatchingService?: Array<WorkflowEventData>;
    tradeClearingService?: Array<WorkflowEventData>;
    tradeSettlementService?: Array<WorkflowEventData>;
}

 ...
 */
@JsonPropertyOrder({
  ErrorResponseBody.JSON_PROPERTY_TIMESTAMP,
  ErrorResponseBody.JSON_PROPERTY_STATUS,
  ErrorResponseBody.JSON_PROPERTY_ERROR,
  ErrorResponseBody.JSON_PROPERTY_MESSAGE,
  ErrorResponseBody.JSON_PROPERTY_PATH
})
